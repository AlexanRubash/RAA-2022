...
.const
	...
	L8 WORD 2
	L9 BYTE 'print();', 0
	L10 BYTE 'Output of values c and a:', 0
	L11 BYTE 'hi', 0
	L12 BYTE 'Hello world', 0
	L13 BYTE 'Output of line str1 and str2:', 0
	L14 BYTE 'lexicographic string comparison str3 and str4:', 0
	L15 BYTE 'hello', 0
	L16 BYTE 'hello ', 0
	L17 BYTE 'accessing the function ~min~:', 0
	L18 BYTE 'accessing the function ~max~:', 0
	L19 BYTE 'accessing the function ~more~:', 0
	L20 WORD 300
	L21 BYTE 'accessing the function ~equal~, when a=111(binary):', 0
	L22 WORD 7
	L23 BYTE 'accessing the function ~equal~, when a!=111(binary) and <111:', 0
	L24 WORD 3
	L25 BYTE 'I love you, Artur', 0
	L26 WORD 0
